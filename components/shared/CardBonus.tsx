   ...
   return (
      <div className="shadow-orange-300 border-4 border-orange-400 shadow-md flex flex-col mx-auto rounded-3xl">
         ...
         <div className="p-7 bg-zinc-950 text-2xl rounded-[inherit]">
            <h6 className="italic text-tema font-bold text-[19px] underline">Bônus #0{Number(chave) + 1}</h6>
            <p className="text-3xl font-semibold mt-2 mb-4 text-green-300">{titulo}</p>
            <p>{descricao}</p>
            <div className="mt-4">
               <p>
